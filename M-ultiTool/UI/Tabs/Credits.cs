...
namespace MultiTool.UI.Tabs
{
	internal class CreditsTab : Tab
	{
		...
		public override void RenderTab(Rect dimensions)
		{
			...
			_currentPosition = GUI.BeginScrollView(new Rect(creditsX, creditsY, creditsWidth, creditsHeight), _currentPosition, new Rect(0, 0, creditsWidth, totalCreditsHeight));
